...
let lastMessageTime = Date.now(), badMessageCount = 0;
...
function setExpPlot(board, i, sensor) {
  const maxVal = 0.256;
  const voltage = Math.round((sensor.photodiodeVoltage * 0.00032) * 1000) / 1000; // TODO: remove magic numbers = (0.256 * (0x8000 >> 4)), Gain 16X
